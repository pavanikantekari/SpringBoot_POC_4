package com.ojas.jobapp.service;
...
import com.ojas.jobapp.dao.JobRepo;
...
public class UserJobService {
	...
	@Autowired
	com.ojas.jobapp.dao.UserRepo userRepo;
	...
	// getting Job
	public Iterable<com.ojas.jobapp.domain.Job> getJob(Job job) {
